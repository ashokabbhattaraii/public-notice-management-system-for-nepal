...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "nav.product.problem": "Problem",
    "nav.product.solution": "Solution",
  ...
  ne: {
    ...
    "nav.adminPanel": "प्रशासन प्यानल",
    "nav.product.problem": "समस्या",
    "nav.product.solution": "समाधान",
    "nav.product.features": "विशेषताहरू",
